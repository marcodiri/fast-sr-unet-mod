...
class ARArgs:
    def __init__(self, args=None):
        ...
        ap.add_argument(
            "--export", type=str, default="", help="Where to export models."
        )
        ap.add_argument(
            "-e",
            "--epochs",
        ...
        ap.add_argument("--w0", type=float, default=1.0, help="LPIPS weight")
        ap.add_argument("--w1", type=float, default=1.0, help="SSIM Weight")
        ap.add_argument(
            "--l0", type=float, default=0.001, help="Adversarial Component Weight"
        )
        ap.add_argument(
            "--upscale",
            type=int,
